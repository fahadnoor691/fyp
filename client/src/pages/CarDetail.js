    ...
    axios
      ...
      .then((res) => {
        if (res.status === 201) {
          ...
          // Handle the conflict scenario differently
          // You might want to prevent navigation or perform other actions
        } else {
          ...
          <table className="w-full border-collapse border-t border-gray-300">
            <tbody>
              <tr className={"bg-white"}>
                <td className="px-2 py-2 font-medium text-gray-700">Model</td>
                <td className="px-10 py-2 text-gray-600">{carData.model}</td>
              </tr>
              <tr className={"bg-gray-100"}>
                <td className="px-2 py-2 font-medium text-gray-700">Seats</td>
                <td className="px-10 py-2 text-gray-600">{carData.seats}</td>
              </tr>
              <tr className={"bg-white"}>
                <td className="px-2 py-2 font-medium text-gray-700">Mileage</td>
                <td className="px-10 py-2 text-gray-600">{carData.mileage}</td>
              </tr>
              <tr className={"bg-gray-100"}>
                <td className="px-2 py-2 font-medium text-gray-700">
                  Car Type
                </td>
                <td className="px-10 py-2 text-gray-600">{carData.carType}</td>
              </tr>
              <tr className={"bg-white"}>
                <td className="px-2 py-2 font-medium text-gray-700">
                  Transmission
